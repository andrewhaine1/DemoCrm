...
namespace DemoCrm.Data.Migrations
{
    ...
    [Migration("20190227120037_BusinessLeadManagerAsStaffMember")]
    partial class BusinessLeadManagerAsStaffMember
    {
            ...
            modelBuilder.Entity("DemoCrm.Data.Entities.BusinessLead", b =>
                {
                    ...
                    b.Property<Guid>("StaffMember.Id");

                    b.Property<Guid>("StaffMemberId");

                    b.HasKey("Id");

                    b.HasIndex("StaffMember.Id");
